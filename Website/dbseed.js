...
var pc2 = new productCategory("Pants", new objectId("57eb54e04094031a409f06f9"));
...
MongoClient.connect('mongodb://localhost:27017/estoredb', function(err, db) {
  ...
  myCollection.insert([
	...
	{categoryId:pc1._id, productName:"Grey T-Shirt.jpg",productType:"Trouser",description:"Trouser-crocks-club",price:500.00, imageSource:"Trouser-crocks-club.jpg"},
	{categoryId:pc1._id, productName:"RoundNeck T-Shirt",productType:"Trouser",description:"Goswhit-36Trouser",price:699.00, imageSource:"Trouser-goswhit-36.jpg"},
	...
	{categoryId:pc2._id, productName:"Jeansbluelee32",productType:"Jeans",description:"Jeansbluelee32",price:999.00, imageSource:"Jeansbluelee32.jpg"},
	{categoryId:pc2._id, productName:"Jeans-blue-ms-newport",productType:"Jeans",description:"Jeans-blue-ms-newport",price:500.00, imageSource:"Jeans-blue-ms-newport.jpg"},
	{categoryId:pc2._id, productName:"Jeans-lue-lee-32",productType:"Jeans",description:"Jeans-lue-lee-32",price:699.00, imageSource:"Jeans-lue-lee-32.jpg"},
	{categoryId:pc2._id, productName:"Jeans-super-x-32-original",productType:"Jeans-super-x-32-original",description:"Jeans-super-x-32-original",price:799.00, imageSource:"Jeans-super-x-32-original.jpg"},
	{categoryId:pc2._id, productName:"Jeans-super-x-38-original",productType:"Jeans-super",description:"Jeans-super-x-38-original",price:599.00, imageSource:"Jeans-super-x-38-original.jpg"},
	...
	{categoryId:pc5._id, productName:"Shirt Formal",productType:"Shirt Formal",description:"Shirt Formal",price:1299.00, imageSource:"ShirtFormal.jpg"},

        {categoryId:pc5._id, productName:"SED UT PERSPICIATIS",productType:"Chinese Fabric",description:"Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever",price:1599.00, imageSource:"p1.jpg"},
	{categoryId:pc5._id, productName:"GREAT EXPLORER",productType:"Japanese Fabric",description:"Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever",price:1599.00, imageSource:"p2.jpg"},
